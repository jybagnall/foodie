...
export default function CurrentCart() {
  const { checkedItemQty } = useContext(CartContext);
  ...
  return (
    <div className="relative flex items-center space-x-1 text-white">
      <div className="relative">
        ...
        <span className="absolute -top-2 -right-2 text-orange-500 text-sm font-bold rounded-full w-5 h-5 flex items-center justify-center">
          {checkedItemQty}
        </span>
      </div>
